window.addEventListener('load', function() {
    ...
    footerH2.textContent = 'Good luck, hope it works!!'; 
    footerH2.style.color = '#ff4500'; 
});
...
navItems.forEach(item => {
  ...
  if (tipe === 'about') {
    isi.innerHTML = `
      ...
      <p>Halo!! nama saya adalah Fauzan, saya adalah seorang pelajar dari SMP Mutiara Depok.</p>
    `;
    ...
    isi.innerHTML = `
      ...
      <p>📱 Twiter/X:  <strong>@idk</strong></p>
    `;
  }
}
function tutupModal() {
